...
threshold_s2 = 1.12 fixed (validated session March 16, 2026)
Objectif : FPR < 1.5%, conserver detection Merge + Shanghai
"""
...
# tau_state fixed (threshold_s2=1.12)
...
ax.axhline(y=1.5, color="#4a7c59", linewidth=1.0, linestyle="--", label="target FPR < 1.5%")
ax.axhline(y=2.12, color="#c47a1e", linewidth=0.8, linestyle=":", label="D2 floor from previous session (2.12%)")
...
ax.set_title("ETH — FPR vs threshold_d2  (S2=1.12 fixed)", color="white", fontsize=11)
